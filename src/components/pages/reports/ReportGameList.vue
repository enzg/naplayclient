      ...
      <el-table ref="multipleTable" :data="tableData" tooltip-effect="dark" style="width: 100%" @selection-change="handleSelectionChange">
        ...
        <el-table-column label="操作" align="left" width="180">
          <template scope="scope">
            <el-button size="small" type="info" @click="gameDetail(scope.row)">详情</el-button>
          </template>
        </el-table-column>
      </el-table>
  ...
  methods: {
    ...
    list(callback) {
      const request = {
        ...
        method: 'get',
        params:{
          gameIds:this.$route.query['gameIds']
        }
      }
    ...
    gameDetail(row) {
      ...
      this.$router.push('/reports/'+ this.$route.params.msn + '/'+ row.type)
    }
  }
}
</script>
